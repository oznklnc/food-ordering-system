...
import com.food.ordering.system.order.service.domain.dto.create.OrderItemCommand;
...
class OrderApplicationServiceTest {
    ...
    public void init() {
        createOrderCommand = CreateOrderCommand.builder()
                ...
                .address(OrderAddressCommand.builder()
                        .street("street_1")
                        .postalCode("1000AB")
                        .city("Paris")
                        .build())
    ...
    void testCreateOrderWithWrongTotalPrice() {
        ...
        assertEquals("Total price is not equal to sum of items price !!", orderDomainException.getMessage());
    }
